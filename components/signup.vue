...
useHead(() => ({
    script:[
        {
            src:"https://t6af67b78.emailsys1a.net/form/217/1186/53e36d869f/embedded.js",
  ...
  <div id="rmOrganism">
    <div class="rmEmbed rmLayout--horizontal rmBase">
      <div data-page-type="formSubscribe" class="rmBase__body rmSubscription">
        <form
          method="post"
          action="https://t6af67b78.emailsys1a.net/217/1186/48bf94f814/subscribe/form.html?_g=1705223548"
      ...
      <div
        ...
        class="rmBase__body rmSubscription hidden"
      >
        <div class="rmBase__content">
          <div class="rmBase__container">
            ...
            <div class="rmBase__section">
              <div class="rmBase__el rmBase__el--text">
                <div class="rmBase__comp--text">
                  Wir haben Ihnen auch schon die erste E-Mail geschickt und
                  bitten Sie, Ihre E-Mail-Adresse über den Aktivierungslink zu
                  bestätigen.
                  <!-- this linebreak is important, don't remove it! this will force trailing linebreaks to be displayed -->
                  <br />
                </div>
