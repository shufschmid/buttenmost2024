    ...
    <v-form name="rechnung" ref="form">
      ...
      >
        <v-row
          ><v-col cols="12"
            ><h1>Lieferschein</h1>
            {{ Bestellung.b2b_Geschaeft[0] }} </v-col
          ><v-col cols="8" align-self="center">
            ...
            <div>
              {{ Bestellung.b2b_Geschaeft[0] }}<br />
              {{ Bestellung.b2b_Strasse[0] }} <br />
              {{ Bestellung.b2b_PLZ[0] }}
              {{ Bestellung.b2b_Ort[0] }}
            </div>
          </v-col>
          <v-col cols="4"
...
//funktioniert nicht mit einloggen, hier eine möglichkeit: https://dev.to/rafaelmagalhaes/authentication-in-nuxt-3-375o
